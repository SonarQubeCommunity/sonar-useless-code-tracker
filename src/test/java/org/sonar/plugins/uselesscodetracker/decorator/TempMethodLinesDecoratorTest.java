...
public class TempMethodLinesDecoratorTest {

  private TempMethodLinesDecorator decorator;

  @Before
  public void setUp() {
    decorator = new TempMethodLinesDecorator();
  }
  ...
  public void dependencies() {
    assertThat(decorator.dependedUpon(), hasItem(TrackerMetrics.TEMP_METHOD_LINES));
  }
}
